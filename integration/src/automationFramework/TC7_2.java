...
public class TC7_2 {
	...
	public static Object main(String[] args) throws InterruptedException, FindFailed {
	    ...
	    driver.findElement(By.xpath("//div[@id='q-app']/div/div[2]/main/div/div/div[2]/label[2]/div/div/div/input")).click();
	    try {
	    ...
	    driver.findElement(By.xpath("//div[@id='q-app']/div/div[2]/main/div/div/div[2]/label[2]/div/div/div/input")).sendKeys("my new last name");
        ...
        Pattern img = new Pattern("myNewLastName.png");
