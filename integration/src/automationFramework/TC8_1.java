...
public class TC8_1 {
	...
	public static Object main(String[] args) throws InterruptedException, FindFailed {
	    ...
	    driver.findElement(By.xpath("//div[@id=\'q-app\']/div/div/main/div/div[2]/label/div/div/div/input")).sendKeys("deleteMe");
	    driver.findElement(By.xpath("//div[@id=\'q-app\']/div/div/main/div/div[2]/label[2]/div/div/div/input")).click();
	    driver.findElement(By.xpath("//div[@id=\'q-app\']/div/div/main/div/div[2]/label[2]/div/div/div/input")).sendKeys("deleteMe");
	    ...
	    Thread.sleep(1000);
	    driver.findElement(By.name("account-delete")).click();  // edit account button
	    Thread.sleep(1000);
	    driver.findElement(By.xpath("//div[2]/button[2]/span[2]/span/span")).click();
	    

	    Thread.sleep(1000);
		String result = "unchanged";
        Screen screen = new Screen();
        Pattern img = new Pattern("accountDeleted.png");
