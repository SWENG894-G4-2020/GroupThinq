...
public class TC7_3 {
	...
	public static Object main(String[] args) throws InterruptedException, FindFailed {
	    ...
	    driver.findElement(By.xpath("//div[@id='q-app']/div/div[2]/main/div/div/div[2]/label[3]/div/div/div/input")).click();
	    try {
	    ...
	    driver.findElement(By.xpath("//div[@id='q-app']/div/div[2]/main/div/div/div[2]/label[3]/div/div/div/input")).sendKeys("myNewEmail@gmail.com");
        ...
        Pattern img = new Pattern("myNewEmail.png");
