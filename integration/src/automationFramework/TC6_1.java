...
public class TC6_1 {
	...
	public static Object main(String[] args) throws InterruptedException, FindFailed {
	    ...
	    driver.findElement(By.name("decision-delete")).click();  // delete button
	    Thread.sleep(1000);
	    driver.findElement(By.name("decision-delete-confirm")).click();
	    Thread.sleep(1000);
        ...
        Pattern img = new Pattern("noDecisionsFound.png");
